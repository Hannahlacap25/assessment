...
include("classes/post.php");
    ...
    if(isset($_SESSION['userid']))
    {
        ...
        if($result){
            ...
            $images = $user_data['profile_image'];
            ...
            <div class="row">
                    ...
                    <div class="col">
                        <div class="container round spacing">
                            <form method="POST" class="post">
                                ...
                                <textarea class="pink-bg white" name="post" cols="68" rows="4" maxlength="230" placeholder="What's on your mind?"></textarea>
                ...
                <div class="col">
                    <div class="col profile text-center">
                        <img src="<?php echo $images ?>" width="100rem">
